...
//                             sh 'docker tag chiehmin/hello-eks:latest 654661216054.dkr.ecr.us-east-2.amazonaws.com/spring-eks:latest'
                            sh 'docker tag springboot3:latest 654661216054.dkr.ecr.us-east-1.amazonaws.com/springboot3:2'
        ...
        stage('push into ECR'){
            steps{
                ...
                sh 'docker push 654661216054.dkr.ecr.us-east-1.amazonaws.com/springboot3:2'
            }
        }
        stage('eks'){
            steps{
